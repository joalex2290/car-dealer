...
class VentasForm(forms.ModelForm):
	...
	id_venta = forms.IntegerField(widget=forms.NumberInput(attrs={'class':'span1'}))
...
VentaLineaFormset = inlineformset_factory(Venta, VentaLinea, form=VentasLineaForm, extra=1)